\section{Descripció de les tasques} \label{sec:descripcio( hores) -tasques}
...
\begin{itemize}
    \item \textbf{TP1 (10 hores) - Aprenentatge.}
        Formació per obtenir els coneixements previs necessaris per iniciar correctament el projecte, tals com: l'aprenentatge autònom, el processament del llenguatge natural (NLP), bases de dades basades en \textit{OTRS}, sistemes d'emmagatzematge utilitzant Elasticsearch, etc.
