...
El model del llenguatge natural que s'ha entrenat ha obtingut un encert global del 71,4\% en l'extracció dels camps amb un 89,5\% dels camps etiquetats com a \pyth{"NotFound"}. Tot i això, és important assenyalar que es tracta d'una iteració inicial i que es preveu una millora futura amb les pròximes revisions. El model es continuarà perfeccionant per incrementar la precisió en futures iteracions.
