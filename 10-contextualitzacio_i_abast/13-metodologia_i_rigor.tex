...
\begin{itemize}
    ...
    \item \textbf{Logstash:} És un pipeline de processament de dades que transforma les dades abans de ser emmagatzemades a Elasticsearch. S'ha utilitzat per pseudoanonimitzar els camps abans d'emmagatzemar-los.
