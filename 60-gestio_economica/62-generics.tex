...
El cost elèctric que es calcularà serà el dels ordinadors de sobretaula que es fan servir amb dos monitors cadascun. El teclat i el ratolí tenen una potència negligible en aquest càlcul. Com s'ha calculat a la taula \ref{fig:costos_tasques}, en total s'invertiran 1345 hores en aquest projecte entre tots els integrants de l'equip. El preu mitjà de la llum de 0,1728\text{\euro}/kWh \cite{preu-llum}, un ordinador amb un consum de 400 W \cite{watts-ordinador}, les dues pantalles de cada monitor són idèntiques amb un consum màxim de 35 W \cite{watts-monitor}.
