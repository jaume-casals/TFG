...
$$
\text{Amortització Hardware} = 1.200\text{\euro} * 3 \text{ unitats} * \frac{4}{60} \text{ mesos} = 240\text{\euro}
$$

\subsection{Consum elèctric}
El cost elèctric que s'ha calculat serà el dels ordinadors de sobretaula que es fan servir amb dos monitors cadascun. El teclat i el ratolí tenen una potència negligible en aquest càlcul. Com s'ha calculat a la taula \ref{fig:costos_tasques}, en total s'han invertit 1.345 hores en aquest projecte entre tots els integrants de l'equip. El preu mitjà de la llum de 0,1728\text{\euro}/kWh \cite{preu-llum}, un ordinador amb un consum de 400 W \cite{watts-ordinador}, les dues pantalles de cada monitor són idèntiques amb un consum màxim de 35 W \cite{watts-monitor}.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|r|}
        ...
        \hline
        \textbf{\begin{tabular}{@{}c@{}}Ordinador \\ sobretaula\end{tabular}} & 400 W & 3 & 1.345 & 1.614 kWh & 278,9\euro \\
        \hline
        \textbf{Pantalla} & 35 W & 6 & 1.345 & 282,45 kWh & 48,81\euro \\
        \hline
        \textbf{Total}    & \textbf{470 W} & \textbf{3} & \textbf{1.345} & \textbf{1.896,45 kWh} & \textbf{327,71\euro} \\
        \hline
    \end{tabular}
...
S'ha calculat que el preu de la connexió a internet ronda els 50\euro \space per mes. Amb un projecte de quatre mesos de duració, el total ha sigut de:
